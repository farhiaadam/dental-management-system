    ...
    return (
      <div className="fixed right-0 top-1/2 -translate-y-1/2 z-50">
        <button 
          ...
          className="bg-[#dfb28c] text-neutral-950 text-xs font-bold py-4 px-2.5 rounded-l-md shadow-2xl border-y border-l border-white/25 [writing-mode:vertical-lr] rotate-180 hover:bg-[#c99f7a] active:scale-95 transition-all duration-200 flex items-center gap-1"
        >
          <span>📅</span> Book Now
        </button>
      </div>
